...
public class FoodController {
  ...
  public ResponseEntity<String> addBeforeFood(@RequestPart("beforeimg") MultipartFile beforeImg,@AuthenticationPrincipal
  ...
  public ResponseEntity<String> verifyFoods(@RequestPart("afterimg") MultipartFile afterImg,
